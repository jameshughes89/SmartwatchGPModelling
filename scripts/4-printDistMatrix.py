...
plt.colorbar(label='Mean Absolute Error (limited at 2)')
#plt.show()
'''
...
plt.title('Distance Matrix ' + TIME + ': Averaged Over Takes')
plt.ylabel('Data',rotation=90)
plt.xlabel('Model')
plt.yticks(range(2,30,6), tasks, rotation=90)
plt.xticks(range(2,30,6), tasks, rotation=0)
plt.colorbar(label='Mean Absolute Error (limited at 2)')
#plt.show()
'''
...
plt.title('Distance Matrix ' + TIME + ': Averaged Over Tasks')
plt.ylabel('Data',rotation=90)
plt.xlabel('Model')
plt.yticks(range(0,5,1), tasks, rotation=90)
plt.xticks(range(0,5,1), tasks, rotation=0)
plt.colorbar(label='Mean Absolute Error (limited at 2)')
#plt.show()
'''
