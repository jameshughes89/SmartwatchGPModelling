'''
prints the accuracy matrix generated from 5 -- VOTE version though
...
iFile =  csv.reader(open('5-accMatVote_G' + str(GROUP_SIZE) + '_' + TIME + '.csv', 'r'))
...
plt.title('Accuracy Matrix: VOTE VOTE VOTE --- ' + TIME + ' (Batch of ' + str(GROUP_SIZE) + ')')
