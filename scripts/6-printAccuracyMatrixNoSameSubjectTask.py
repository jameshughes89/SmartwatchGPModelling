...
iFile =  csv.reader(open('5-accMatNoSameSubjectTask_G' + str(GROUP_SIZE) + '_' + TIME + '.csv', 'r'))
...
plt.axvline(59.5, color='k', linewidth=2)
plt.axvline(89.5, color='k', linewidth=2)
plt.axvline(119.5, color='k', linewidth=2)
...
plt.axvline(4.5, color='k', linewidth=1, linestyle='--')
plt.axvline(9.5, color='k', linewidth=1, linestyle='--')
plt.axvline(14.5, color='k', linewidth=1, linestyle='--')
plt.axvline(19.5, color='k', linewidth=1, linestyle='--')
plt.axvline(24.5, color='k', linewidth=1, linestyle='--')
plt.axvline(29.5, color='k', linewidth=1, linestyle='--')
plt.axvline(34.5, color='k', linewidth=1, linestyle='--')
plt.axvline(39.5, color='k', linewidth=1, linestyle='--')
plt.axvline(44.5, color='k', linewidth=1, linestyle='--')
plt.axvline(49.5, color='k', linewidth=1, linestyle='--')
plt.axvline(54.5, color='k', linewidth=1, linestyle='--')
plt.axvline(59.5, color='k', linewidth=1, linestyle='--')
plt.axvline(64.5, color='k', linewidth=1, linestyle='--')
plt.axvline(69.5, color='k', linewidth=1, linestyle='--')
plt.axvline(74.5, color='k', linewidth=1, linestyle='--')
plt.axvline(79.5, color='k', linewidth=1, linestyle='--')
plt.axvline(84.5, color='k', linewidth=1, linestyle='--')
plt.axvline(89.5, color='k', linewidth=1, linestyle='--')
plt.axvline(94.5, color='k', linewidth=1, linestyle='--')
plt.axvline(99.5, color='k', linewidth=1, linestyle='--')
plt.axvline(104.5, color='k', linewidth=1, linestyle='--')
plt.axvline(109.5, color='k', linewidth=1, linestyle='--')
plt.axvline(114.5, color='k', linewidth=1, linestyle='--')
plt.axvline(119.5, color='k', linewidth=1, linestyle='--')
plt.axvline(124.5, color='k', linewidth=1, linestyle='--')
plt.axvline(129.5, color='k', linewidth=1, linestyle='--')
plt.axvline(134.5, color='k', linewidth=1, linestyle='--')
plt.axvline(139.5, color='k', linewidth=1, linestyle='--')
plt.axvline(144.5, color='k', linewidth=1, linestyle='--')
plt.axvline(149.5, color='k', linewidth=1, linestyle='--')
...
plt.title('Accuracy Matrix: Each Dataset Applied to All Models Except Self --- ' + TIME + ' (Batch of ' + str(GROUP_SIZE) + ')')
