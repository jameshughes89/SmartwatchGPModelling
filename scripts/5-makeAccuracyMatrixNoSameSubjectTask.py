'''
does an accuracy matric. Basicially, it picks the task that the data fits closest to, BUT it ignores the subject the subset of data came from. 
...
np.savetxt('5-accMatNoSameSubjectTask_G'+str(GROUP_SIZE)+'_' + TIME + '.csv', accMat, delimiter=",")
